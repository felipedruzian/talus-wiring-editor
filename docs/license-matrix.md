...
| Fotografias privadas dos módulos do Talus-Droid | Inventário privado no Goblin: `C:\Users\felip\OneDrive\Área de Trabalho\print modulos` | `A3144.jpg`, `lm2596s.webp`, `MPU6050.webp`, `raspi.png`, `tb6612fng.jpg`, inspecionados em 2026-08-28 | Licença de redistribuição **não comprovada** | **Não — somente referência privada.** | As imagens serviram apenas para reconhecer cor, proporção e elementos distintivos dos módulos reais. Nenhum pixel, traçado vetorial, texto de vendedor, logotipo ou arquivo derivado foi copiado para o repositório. As seis ilustrações do catálogo são marcação SVG e CSS originais, escritas manualmente para este projeto. |
...
importada; em particular, os cinco arquivos privados do Goblin não existem no

...
SVG para o cobre e para as guias de polaridade. Nenhum SVG, sprite ou folha de
estilo do `safaorhan/breadboard` foi importado; a grade de furos de qualquer
...
- `safaorhan/breadboard@db5f279`, arquivo `src/board.ts` — lido em 2026-09-03
  para conferir a geometria de referência (ordem das linhas, espaçamentos e
  fórmula das colunas de barramento) registrada acima. O `LICENSE` na raiz do
  repositório confirma MIT, `Copyright (c) 2026 Safa Orhan`.

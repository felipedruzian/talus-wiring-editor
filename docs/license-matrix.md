...
- `safaorhan/breadboard@db5f279`, arquivos `src/board.ts`, `src/render.ts`,
  `src/style.css` e `src/svgExport.ts` — lidos em 2026-09-03 para conferir a
